...
export const Tree: React.NamedExoticComponent<TreeProps> = React.memo(props => {
  ...
  return (
    ...
    >
      <ButtonBase
        ...
        className={css({ position: 'relative', padding: 0, top: -2, marginRight: 10 })}
      ...
      <Text type={ETextType.Label} style={{ display: 'inline-block', verticalAlign: 'middle' }}>
        {name}
      </Text>
      <animated.div
        className={css({
